...
interface NotificationToastWithBadgeAndActionProps {
  title: string;
  message: string;
  badgeLabel: string;
...
export const NotificationToastWithBadgeAndAction = ({ title, message, badgeLabel, type = 'info', onClose, onAction, actionLabel = 'Ver', duration = 5000 }: NotificationToastWithBadgeAndActionProps) => {
  useEffect(() => {

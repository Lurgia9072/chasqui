...
interface NotificationToastWithCountdownAndActionProps {
  title: string;
  message: string;
...
export const NotificationToastWithCountdownAndAction = ({ title, message, type = 'info', onClose, onAction, actionLabel = 'Ver', duration = 5000 }: NotificationToastWithCountdownAndActionProps) => {

...
interface NotificationToastWithUndoProps {
  title: string;
  message: string;
...
export const NotificationToastWithUndo = ({ title, message, type = 'info', onClose, onUndo, duration = 5000 }: NotificationToastWithUndoProps) => {
  useEffect(() => {

...
interface NotificationToastWithBadgeAndUndoProps {
  title: string;
  message: string;
  badgeLabel: string;
...
export const NotificationToastWithBadgeAndUndo = ({ title, message, badgeLabel, type = 'info', onClose, onUndo, duration = 5000 }: NotificationToastWithBadgeAndUndoProps) => {
  useEffect(() => {

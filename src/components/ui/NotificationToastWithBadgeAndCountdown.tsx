...
interface NotificationToastWithBadgeAndCountdownProps {
  title: string;
  message: string;
  badgeLabel: string;
...
export const NotificationToastWithBadgeAndCountdown = ({ title, message, badgeLabel, type = 'info', onClose, duration = 5000 }: NotificationToastWithBadgeAndCountdownProps) => {

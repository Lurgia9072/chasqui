...
interface NotificationToastWithAvatarAndActionProps {
  title: string;
  message: string;
  avatarName: string;
  avatarUrl?: string;
...
export const NotificationToastWithAvatarAndAction = ({ title, message, avatarName, avatarUrl, onClose, onAction, actionLabel = 'Ver', duration = 5000 }: NotificationToastWithAvatarAndActionProps) => {
  useEffect(() => {

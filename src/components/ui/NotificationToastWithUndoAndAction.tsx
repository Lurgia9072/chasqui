...
import { Bell, X, CheckCircle, AlertCircle, Info, XCircle, RotateCcw, ArrowRight } from 'lucide-react';
import { cn } from '../../lib/utils';
import { motion, AnimatePresence } from 'motion/react';
import { Button } from './Button';

interface NotificationToastWithUndoAndActionProps {
  title: string;
  message: string;
...
export const NotificationToastWithUndoAndAction = ({ title, message, type = 'info', onClose, onUndo, onAction, actionLabel = 'Ver', duration = 5000 }: NotificationToastWithUndoAndActionProps) => {
  useEffect(() => {

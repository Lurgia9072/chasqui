...
interface NotificationToastWithCountdownProps {
  title: string;
  message: string;
...
export const NotificationToastWithCountdown = ({ title, message, type = 'info', onClose, duration = 5000 }: NotificationToastWithCountdownProps) => {

...
interface NotificationToastWithImageProps {
  title: string;
  message: string;
  imageUrl: string;
  onClose: () => void;
...
export const NotificationToastWithImage = ({ title, message, imageUrl, onClose, duration = 5000 }: NotificationToastWithImageProps) => {
  useEffect(() => {

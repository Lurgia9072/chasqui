...
interface NotificationToastWithAvatarAndCountdownProps {
  title: string;
  message: string;
  avatarName: string;
  avatarUrl?: string;
...
export const NotificationToastWithAvatarAndCountdown = ({ title, message, avatarName, avatarUrl, onClose, duration = 5000 }: NotificationToastWithAvatarAndCountdownProps) => {
